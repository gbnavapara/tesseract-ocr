                                                 ...
                                                 int timeout_millisec)
{
	...
	if (handle->ProcessPages(filename, retry_config, timeout_millisec, &text_out, flag_thr, boxONrlw))
...
{
	STRING text_out; bool flag_thr; int boxONrlw;
	if (handle->ProcessPage(pix, page_index, filename, retry_config, timeout_millisec, &text_out, flag_thr, boxONrlw))
        return text_out.strdup();    
    else
        return NULL;
}
